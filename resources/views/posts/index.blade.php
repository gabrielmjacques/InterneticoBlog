<x-app-layout>
    <x-slot name="slot">
        <div class="flex">
            <div
                class="w-4/5 min-h-96 border-x border-y-0 border-solid border-black border-opacity-10 px-5 me-5 relative">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div
                        class="w-full h-full flex flex-col transition-all bg-white active:bg-violet-100 ring-0 ring-violet-500 active:ring-2 active:ring-offset-2 rounded-md overflow-hidden shadow-xl border border-gray-300 cursor-pointer hover:brightness-90">
                        <a href="{{ route('posts.show', ['post' => $post]) }}">
